                ...
                <main className={classes.main}>
                    ...
                    <Grid container className={classes.grid}>
                        ...
                        <Grid item xs={12} md={3} className={classes.grid_item}>
                            {!read_only &&
                                <Paper className={classes.paper}>
                                    <FormControl margin="normal" className={classes.mark_all_select}>
...
function mapStateToProps({ hr, user }) {
    return {
        daily_attendance: hr.attendance.daily_attendance,
        loading: hr.attendance.loading_daily_attendance,
