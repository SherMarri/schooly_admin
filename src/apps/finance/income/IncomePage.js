...
const pie_options = {
    ...
    exportFileName: "Income Distribution - 2019",
    exportEnabled: true,
    title:{
        text: "Income Distribution - 2019"
    },
    data: [{
        type: "pie",
        showInLegend: true,
...
const daily_income_options = {
    animationEnabled: true,
    exportEnabled: true,
    exportFileName: "Daily Income - May 2019",
    // theme: "light2", //"light1", "dark1", "dark2"
    title:{
        text: "Daily Income - May 2019"
    },
    data: [{
        ...
        return (
            <Grid container spacing={24}>
                ...
                <Grid item xs={12} md={6}>
                    <Paper className={classes.paper}><Chart options={daily_income_options}/></Paper>
...
export default withStyles(styles)(IncomePage);