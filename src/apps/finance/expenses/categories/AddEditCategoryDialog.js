...
class AddEditCategoryDialog extends React.Component {
    ...
    handleSubmit = (event) => {
        ...
        if (this.props.item && this.props.edit) {
            this.props.updateCategory(form.id, form);
        }
        else {
...
function mapDispatchToProps(dispatch) {
    return bindActionCreators({
        addCategory: Actions.createCategory,
        updateCategory: Actions.updateCategory,
    }, dispatch);
}

export default withStyles(styles)(connect(mapStateToProps, mapDispatchToProps)(AddEditCategoryDialog));